### UDP server - Visited Base Station (B)
...
pyRAPL.setup()
filename = 'E-Visiting Base Station.csv'
...
def Visiting():
    ...
    while(True):
        ...
        if 1001 in address:
            ...
            ### send - B to C
            bytesToSend = message2,NewID,SecretKey,nb,tb
