...
def Authentication():
    ...
    ta = str(int(time.time()))  #timestamp
    ...
    while(True):
        ...
        # send - A to C
        #***
        hashNaNc = getESHA256(na+nc,ESHA)
        hashNaTa = getESHA256(na+ta,ESHA)
        bytesToSend = na,ta,hashNaNc,hashNaTa
    ...
    ### send 3 - A to B
    bytesToSend2 = OldID,na,tc,ta,hashNaTa
